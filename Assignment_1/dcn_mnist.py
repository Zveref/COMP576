...
def main():
    ...
    train_step = tf.train.AdamOptimizer(1e-4).minimize(cross_entropy) #training algorithms
    # train_step = tf.train.GradientDescentOptimizer(1e-4).minimize(cross_entropy)
    # train_step = tf.train.MomentumOptimizer(1e-4, 0.7).minimize(cross_entropy)
    ...
    # initial = initializer(shape = [None, 784])
    # return tf.Variable(initial)
